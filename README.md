...
The test coverage is measuring using  <a href="https://github.com/coverlet-coverage/coverlet" taget="_blank">coverlet</a> and  <a href="https://github.com/danielpalme/ReportGenerator" taget="_blank">ReportGenerator</a>  converts coverage xml generated by coverlet to reports using html. Once you build the test project run `dotnet test` command from the command prompts from the UserServiceTest folder. The report can be viewed from the index.html file in Coverage/Report folder.
